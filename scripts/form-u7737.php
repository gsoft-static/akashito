...
{
	$to = 'pedidos@akashito.com';
	$subject = 'Envío de Pedidos Akashito';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U7743"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Message:</b></td><td>' . htmlentities($_REQUEST["custom_U7738"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Teléfono móvil:</b></td><td>' . htmlentities($_REQUEST["custom_U7767"],ENT_COMPAT,'UTF-8') . '</td></tr>';
